...
<div class="text-center mt-5 mb-3">
    ...
    <button type="submit" class="btn btn-secondary bg-danger text-black mt-4 mb-3" value="back"
...
<div class="container mt-5 mb-5" id="seleccion">
    <div class="card card-body border-dark ">
        <ul>
            ...
            <li><strong>Total Cost:
                </strong><?php echo $oneTransaction->getCostPerTicket() * $oneTransaction->getTicketAmount() ?></li>
         ...
         $tickets = $ticketsPerTT[$oneTransaction->getIdTransaction()];   
            ...
            <button type="button" class="btn btn-primary btn-resp-user" data-toggle="modal"
                data-target="#exampleModal-<?=$oneTT->getIdTicket()?>">
                Ticket <?=$i?>
            </button>
            <!-- Modal -->
            <div class="modal fade" id="exampleModal-<?=$oneTT->getIdTicket()?>" tabindex="-1" role="dialog"
