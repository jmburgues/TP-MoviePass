...
<div style="height: 100px; position: relative;">
    <div class="center">
        <button type="submit" class="btn btn-secondary bg-danger text-black mt-1 mb-2" value="back"
    ...
    <div class="row no-gutters">
        <div class="col-md-4 ">
            ...
            <?php
                        ...
                        ?>
            <img src="https://image.tmdb.org/t/p/w400/.<?php echo $selectedMovie->getPoster()?>" class="card-img"
                alt="...">
            <?php
                }?>
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <ul>
                    ...
                    <li><strong>Starting hour: </strong><?php echo date_format($movieStartingHour, 'H:i');;?> <?php ?>
                    </li>
        ...
        <form action="<?php echo FRONT_ROOT?>Show/createNewShow" method="POST" class=" mt-5 mb-5">
            ...
            <tr>
                <td style="text-align:center">
                    <?php echo $oneCinema->getName()."<br><i>(".$oneCinema->getOpenning()." - ".$oneCinema->getClosing()." hrs)</i>"?>
                </td>
                <td style="text-align:center">
            ...
            if(!empty($rooms)){
                if(is_array($rooms)){
                    ...
                    <button type="submit" value="<?php echo $rooms->getId()?>"
                        name="roomId"><?php echo $rooms->getName()?></button>
