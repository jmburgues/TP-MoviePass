  ...
  <div class="mt-3">
    <form  action="<?php echo FRONT_ROOT ?>Ticket/addTicket" method="POST">
      ...
      <label for="idRoom" ><strong>Movie</strong></label>
        <input disabled type="text" class="form-control font-weight-bold"  placeholder=<?php echo $selectedMovie->getTitle()?> name="movie" value="<?php echo $selectedMovie->getTitle()?>">
      </div>
      <div class="form-group">
