    ...
    <div class="mt-3">
        <form action="<?php echo FRONT_ROOT ?>Ticket/payment" method="POST">
            ...
            <div class="form-group ">
                ...
                ?> type="number" min="<?php echo $min ?>" max="<?php echo $max ?>" class="form-control"
                    placeholder="<?=$max?> tickets aviable" name="ticketAmount" required>
            </div>
            ...
            <input type="submit" class="btn btn-primary bg-danger text-white mt-5 col-md-3 float-right "
                value="Next"></input>
        </form>
        <button type="submit" class="btn btn-secondary bg-danger text-black  col-md-3 btn-ticket-resp" value="back"
