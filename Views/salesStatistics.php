...
<p class="text-center mt-5 mb-3">
    <button class="btn btn-primary bg-danger text-black mt-3" type="button" data-toggle="collapse"
        data-target="#betweenDates" aria-expanded="false" aria-controls="collapseExample">
        Check between dates
    </button>
</p>
...
<p class="text-center">
    <button class="btn btn-primary bg-danger text-black mt-3" type="button" data-toggle="collapse"
        data-target="#existentShow" aria-expanded="false" aria-controls="collapseExample">
...
<p class="text-center">
    <button class="btn btn-primary bg-danger text-black mt-3 " type="button" data-toggle="collapse"
        data-target="#existentCinema" aria-expanded="false" aria-controls="collapseExample">
...
<p class="text-center">
    <button class="btn btn-primary bg-danger text-black mt-3" type="button" data-toggle="collapse"
        data-target="#existentRoom" aria-expanded="false" aria-controls="collapseExample">
