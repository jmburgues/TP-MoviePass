    ...
    <div class="row no-gutters ">
        <div class="col-md-4">
            ...
            <?php
                ...
                ?>
            <img src="https://image.tmdb.org/t/p/w400/.<?php echo $movieForShows[0]->getPoster()?>"
                class="card-img card-img-respons" alt="...">
            <?php
            }    
            ?>
        </div>
        ...
        <div class="col-md-8">
            <div class="card-body ">
                <ul class="card-body-resp">
                    ...
                    <li><strong>Show date:</strong> <?=$showSelected->getDate();?> <strong>Starts at:</strong>
                        <?= $showSelected->getStart();?> <strong>Ends At:</strong> <?=$showSelected->getEnd();?></li>
                ...
                <div style="height:100px;" class="mt-4">
                    <hr>
                        ...
                        <table style="text-align:center;" class="mt-4 table-resp">
                            <tr>
                                <td>
                                    ...
                                    <input hidden type="number" value=<?php echo $costPerTicket?> class="form-control"
                                        name="costPerTicket">
                                    <input hidden type="number" value=<?php echo $totalCost?> class="form-control"
                                        name="totalCost">
                                    <input hidden type="number" value=<?php echo $ticketAmount?> class="form-control"
                                        name="ticketAmount">
                                    <div style="margin-left:40px">
                                        <div readolny class="form-group font-weight-bold pt-2">
                                            <label for="cardNumber">Card </label>
                                            <input readonly type="text" placeholder=<?php echo $cardBank?>
                                        ...
                                        <div class="form-group font-weight-bold pt-2">
                                            ...
                                            <input type="text" pattern=<?php echo $pattern?> min="1" max="9"
                                                class="form-control" name="cardNumber" required>
                                        </div>
                                ...
                                <td>
                                    <div>
                                        <div style="margin-left:60px; margin-top:-40px">
                                            <div class="form-group font-weight-bold pt-2 cvc-resp">
                                                ...
                                                <span class="text-muted muted-resp"> security code behind the
                                                    card</span>
                                                <input type="number" min="100" max="999" placeholder="123"
                                    ...
                                    <input type="hidden" class="form-control" name="cardBank"
                                        value=<?php echo $cardBank ?>>
                                </td>
                            </tr>
                        </table>

                        <div class="text-center mt-resp">
                            <input type="submit" class=" but-resp btn btn-primary bg-danger text-white  mt-4 col-md-3"
                                value="Confirm"></input>
                        </div>
                    </form>
                </div>
