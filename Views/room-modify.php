...
<div style="margin-top:10px;">
    ...
    <h3 class="text-center" style="color:white;" >Modify <?php echo $currentRoom->getCinema()->getName()?>'s room: <?php echo $currentRoom->getName()?><h3>
...
<div class="container mt-2 mb-5">   
    ...
    <form  action="<?php echo FRONT_ROOT ?>Room/modifyRoom" method="POST">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" maxlength="49" name="name" value=<?php echo $currentRoom->getName() ?> required>
            </div>
        </div>
        <div class="form-group row ">
            <label for="inputName" class="col-sm-2 col-form-label">Capacity</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" min='0' max='9999' name="capacity" value=<?php echo $currentRoom->getCapacity() ?> required>
            </div>
        </div>
        <div class="form-group row">
            <label for="inputDireccion" class="col-sm-2 col-form-label">Price</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" min='0' max='9999' name="price" value=<?php echo $currentRoom->getPrice() ?> required>
            </div>
        </div>
        <div class="form-group row">
