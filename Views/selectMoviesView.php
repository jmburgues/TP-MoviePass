...
<?php
  ...
  <div class="card" style="margin-top:30px; height:720px">
    ...
    <form class="form-inline my-2  my-lg-2 " action="<?php echo FRONT_ROOT?>Movie/selectIdMovie/<?php $movies[$i]->getMovieID(); ?>" method=GET>
        <button type="submit" value="<?php $movies[$i]->getMovieID();?>" class="btn btn-secondary"> Select Movie </button>
    </form>
