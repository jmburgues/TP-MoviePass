...
<div class="container text-center" id="maxWidth1600">
    <div class="row row-home row-cols-5 col-5-resp mr-3">
                ...
                <div class="card-body  ">
                    ...
                    <form action="<?php echo FRONT_ROOT?>User/showLoginForm" method="POST">
                        ...
                        <form action="<?php echo FRONT_ROOT?>Ticket/selectShow" method="POST">
                            <?php } ?>
                            <button value="<?php echo $movies[$i]->getMovieID()?>" name="movieId"
                                class="btn btn-secondary bg-danger text-black mb-2" type="submit">Buy Tickets</button>
                        </form>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination pag-resp justify-content-center mt-3 ">
                <li class="page-item border-0 <?php echo $page <= 1 ? "disabled" : "" ?>"><a
                        ...
                        href="<?php echo FRONT_ROOT?>Home/Index/<?php echo $page-1 ?>">Previous</a></li>

                <?php for($i=0; $i<$pages; $i++) {?>
                <li class="page-item border-0 <?php echo $page == $i+1 ? "active" : ""?>"><a
                        style="background-color: <?php echo $page == $i+1 ? "red" : ""?>"
                        class="page-link text-dark btn btn-danger"
                        href="<?php echo  FRONT_ROOT?>Home/Index/<?php echo $i+1?>"> <?php echo $i+1?></a></li>
                <?php }?>

                <li class="page-item border-0 <?php echo $page >= $pages ? "disabled " : "" ?>"><a
                        class="page-link text-dark btn btn-danger"
                        href="<?php echo FRONT_ROOT?>Home/Index/<?php echo $page+1 ?>">Next</a></li>
            </ul>
        </nav>
