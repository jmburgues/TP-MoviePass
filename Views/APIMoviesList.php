...
<div style="margin-top:10px;">
    ...
    <h3 class="text-center text-white">Select new movies:<h3>
...
<div class="container">
    <div class="center mt-2 mb-4 text-center">
        ...
        <button type="submit" class="btn btn-secondary bg-danger text-black mt-3" value="<?php ?>"
            onclick="window.location.href='<?php echo FRONT_ROOT?>Movie/viewDataBaseMovies'"> View Movies Database
        </button>
    </div>
</div>
            ...
            ?>
                ...
                <div class="card-body  ">
                    ...
                    <form class="form-inline my-2 my-lg-2 "
                        action="<?php echo FRONT_ROOT?>Movie/addSelectedMovie/<?php echo $movies[$i]->getMovieID(); ?>"
                        method=GET>
                        <button type="submit" value="<?php echo $movies[$i]->getMovieID();?>"
                            class=" marginl30 btn btn-secondary bg-danger text-black mb-2"> Add Movie </button>
                    </form>
                    <p>
                        <?php
                ...
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu dropdown-menu-right p-2 dropDownCard" id="dropDownCard"
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center mt-3">
                <li class="page-item border-0<?php echo $page <= 1 ? "disabled" : "" ?>"><a
                        ...
                        href="<?php echo FRONT_ROOT?>Movie/listAPIMovies/<?php echo $page-1 ?>">Previous</a></li>
                <?php for($i=0; $i<$pages; $i++) {?>
                <li class="page-item border-0<?php echo $page == $i+1 ? "active" : ""?>"><a
                        style="background-color: <?php echo $page == $i+1 ? "red" : ""?>"
                        class="text-dark page-link text-dark btn btn-danger "
                        href="<?php echo  FRONT_ROOT?>Movie/listAPIMovies/<?php echo $i+1?>"> <?php echo $i+1?></a></li>
                <?php }?>
                <li class="page-item border-0 <?php echo $page >= $pages ? "disabled" : "" ?>"><a
                        class="page-link text-dark btn btn-danger  "
                        href="<?php echo FRONT_ROOT?>Movie/listAPIMovies/<?php echo $page+1 ?>">Next</a></li>
            </ul>
        </nav>
        <?php } ?>
    </div>
...
<p class="text-muted text-center mb-5"> <?php echo "PLEASE TRY AGAIN LATER"?>
<p><?php
      } ?>
    </div>