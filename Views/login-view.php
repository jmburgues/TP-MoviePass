    ...
    <div class="abs-center">
        <form action="<?php echo FRONT_ROOT;?>User/frontLogin" method=POST>
            <div class="form-group">
                ...
                <input type="text" maxlength="20" name="userName" placeholder="Username" id="userName"
                    class="form-control" required>
            </div>
            <div class="form-group mt-5">
                <strong><label for="password">Password</label></strong>
                <input type="password" maxlength="40" name="pass" placeholder="********" id="password"
                    class="form-control mb-5" required>
            </div>
            <div>
                <?php if(isset($error)) echo "<p style=\"color:red; text-align:center;\">".$error."</p><br>";?>
            </div>
            <button type="submit" class="btn btn-secondary bg-danger col-md-3 btn-resp-log" value="back"
